    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
      ...
      >
        <svg width="18" height="18" viewBox="0 0 48 48">
          <path
            fill="#4285F4"
            d="M44.5 20H24v8.5h11.8C34.7 33.9 29.9 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 5.1 29.6 3 24 3 12.9 3 4 11.9 4 23s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.7-.4-4l.9 1z"
          />
          <path
            fill="#34A853"
            d="M6.3 14.7l7 5.1C15 16.1 19.2 13 24 13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 5.1 29.6 3 24 3 16.3 3 9.7 7.9 6.3 14.7z"
          />
          <path
            fill="#FBBC05"
            d="M24 43c5.8 0 10.7-1.9 14.3-5.2l-6.6-5.4C29.9 34.3 27.1 35 24 35c-5.8 0-10.8-3.1-13.5-7.8l-7 5.4C7.1 39.3 15 43 24 43z"
          />
          <path
            fill="#EA4335"
            d="M43.6 20H24v8.5h11.8c-1 2.8-2.9 5.1-5.3 6.7l6.6 5.4C40.9 37.2 44 31 44 24c0-1.3-.1-2.7-.4-4z"
          />
        </svg>
